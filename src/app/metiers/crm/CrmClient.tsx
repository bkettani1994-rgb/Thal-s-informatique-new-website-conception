        ...
        <section className="py-16 bg-cta">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.div {...fadeUp}>
              ...
              <p data-ilink className="text-white/60 text-sm mb-8">Découvrez notre solution <Link href="/solutions/sage-100" className="text-white underline hover:text-accent">Sage 100</Link>.</p>
              <Link
                href="/contact"
