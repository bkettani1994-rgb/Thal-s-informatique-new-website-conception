...
const features = [
  { title: "Nomenclatures & gammes", desc: "Définition des nomenclatures multi-niveaux et des gammes opératoires de fabrication." },
  { title: "Ordres de fabrication", desc: "Création, planification et suivi des ordres de fabrication avec jalons d'avancement." },
  { title: "GPAO", desc: "Gestion de production assistée par ordinateur : planification des charges et des ressources." },
  { title: "Suivi temps réel", desc: "Saisie des temps en atelier et suivi de l'avancement en temps réel depuis les postes de travail." },
  { title: "Contrôle qualité", desc: "Points de contrôle qualité intégrés aux gammes opératoires avec traitement des non-conformités." },
  { title: "Coûts de revient", desc: "Calcul automatique des coûts de revient réels et standard par produit et par ordre de fabrication." },
];

const industries = ["Industrie manufacturière", "Agroalimentaire", "BTP & Matériaux", "Textile & Confection"];

export default function GestionProductionPage() {
  return (
    <>
      <Navbar />
      <main>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.div {...fadeUp}>
              ...
              <p className="text-white/70 text-lg mt-4 max-w-2xl">
                Nomenclatures, GPAO et suivi d&apos;ateliers pour les industriels marocains.
              </p>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.div className="max-w-3xl" {...fadeUp}>
              ...
              <p className="text-secondary mt-4 leading-relaxed">
                Thalès Informatique propose un module de gestion de production industrielle complet : planification, suivi des ordres de fabrication, gestion des ressources et contrôle qualité. Notre solution s&apos;adapte aux industries manufacturières marocaines de toutes tailles.
              </p>
            </motion.div>
          </div>
        </section>
