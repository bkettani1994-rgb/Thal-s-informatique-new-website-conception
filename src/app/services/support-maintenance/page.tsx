...
export const metadata: Metadata = {
  ...
  description:
    "Contrats de maintenance Essentiel, Business et Premium pour Sage X3 et Sage 100 : correctifs, mises à jour légales, sauvegardes et délais d'intervention dès 1h au Maroc et en Afrique.",
  alternates: {
