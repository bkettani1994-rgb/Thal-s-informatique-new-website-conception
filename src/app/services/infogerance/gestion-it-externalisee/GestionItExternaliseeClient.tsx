      ...
      <main className="min-h-screen bg-bg">
        ...
        <section className="pt-32 pb-20 bg-primary relative overflow-hidden">
          <img
            ...
            alt="Gestion IT externalisée et supervision de serveurs par Thalès Informatique"
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <nav aria-label="Fil d'Ariane" className="flex items-center gap-2 text-white/50 text-sm mb-8 flex-wrap">
              ...
              <ChevronRight aria-hidden="true" size={14} />
              <span aria-current="page" className="text-accent">Gestion IT Externalisée</span>
            </nav>
