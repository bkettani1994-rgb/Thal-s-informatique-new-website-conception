...
const offers = [
  {
    ...
    href: "/services/infogerance/gestion-it-externalisee",
  ...
  {
    name: "Sauvegarde & Reprise d'Activité",
    ...
    href: "/services/infogerance/sauvegarde-reprise-activite",
  ...
  },
  {
    ...
    href: "/services/infogerance/cybersecurite",
  ...
  {
    name: "Conseil IT et Support Technique",
    ...
    href: "/services/infogerance/conseil-it-support-technique",
        ...
        <section className="pt-32 pb-20 bg-primary relative overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <nav aria-label="Fil d'Ariane" className="flex items-center gap-2 text-white/50 text-sm mb-8">
              ...
              <ChevronRight aria-hidden="true" size={14} />
              <span aria-current="page" className="text-accent">Infogérance</span>
            </nav>
