            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <motion.div {...fadeUp}>
                <nav aria-label="Fil d'Ariane" className="text-sm text-white/50 mb-6 flex items-center gap-2">
                  ...
                  <ChevronRight aria-hidden="true" size={14} />
                  <span aria-current="page" className="text-white">Industrie</span>
                </nav>
              ...
              >
                <img
                  src="https://res.cloudinary.com/dmutnjgp8/image/upload/v1783697260/homa-appliances-pWUyHVJgLhg-unsplash_iiggnd.webp"
                  alt="Industrie manufacturière au Maroc — ERP production GPAO et gestion des stocks"
        ...
        <section className="py-16 bg-cta">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.div {...fadeUp}>
              ...
              <p data-ilink className="text-white/60 text-sm mb-8">Solutions adaptées : <Link href="/solutions/sage-x3" className="text-white underline hover:text-accent">Sage X3 Maroc</Link>, <Link href="/solutions/gestion-production" className="text-white underline hover:text-accent">Gestion de Production</Link> et <Link href="/metiers/gestion-production" className="text-white underline hover:text-accent">GPAO</Link>.</p>
              <Link
                href="/contact"
