        ...
        <section className="py-16 bg-cta">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.div {...fadeUp}>
              ...
              <p data-ilink className="text-white/60 text-sm mb-8">Solutions adaptées : <Link href="/solutions/sage-x3" className="text-white underline hover:text-accent">Sage X3</Link>, <Link href="/metiers/gestion-production" className="text-white underline hover:text-accent">Gestion de Production</Link> et <Link href="/metiers/etats-comptables-fiscaux" className="text-white underline hover:text-accent">États comptables &amp; fiscaux</Link>.</p>
              <Link
                href="/contact"
