            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <motion.div {...fadeUp}>
                <nav aria-label="Fil d'Ariane" className="text-sm text-white/50 mb-6 flex items-center gap-2">
                  ...
                  <ChevronRight aria-hidden="true" size={14} />
                  <span aria-current="page" className="text-white">Négoce & Distribution</span>
                </nav>
              ...
              >
                <img
                  ...
                  alt="Entrepôt négoce et distribution au Maroc — ERP gestion commerciale et stocks"
        ...
        <section className="py-16 bg-cta">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.div {...fadeUp}>
              ...
              <p data-ilink className="text-white/60 text-sm mb-8">Solutions adaptées : <Link href="/solutions/sage-100" className="text-white underline hover:text-accent">Sage 100</Link> et <Link href="/metiers/gestion-chaine-approvisionnement" className="text-white underline hover:text-accent">Chaîne d&apos;approvisionnement</Link>.</p>
              <Link
                href="/contact"
