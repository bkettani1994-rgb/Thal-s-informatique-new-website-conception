      ...
      <section className="py-20 bg-cta" ref={ctaRef}>
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <motion.div variants={fadeUp}>
              <p data-ilink className="text-white/60 text-sm mb-8">Solutions adaptées : <Link href="/solutions/sage-x3" className="text-white underline hover:text-accent">Sage X3 Maroc</Link> et <Link href="/metiers/gestion-production" className="text-white underline hover:text-accent">Gestion de Production</Link>.</p>
              <Link
                href="/contact"
