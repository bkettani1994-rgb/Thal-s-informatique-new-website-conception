...
export const metadata: Metadata = {
  ...
  description:
    "Compte-rendu de la conférence du 13 mai 2026 à Casablanca, avec Sage, Factorial et Héliolys : enjeux RH, digitalisation de la paie et retours d'expérience d'entreprises marocaines.",
  alternates: {
