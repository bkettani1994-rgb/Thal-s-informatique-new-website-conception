...
export const metadata: Metadata = {
  ...
  description:
    "Sage Espace Employés permet à vos collaborateurs de consulter bulletins de paie, congés et documents RH en ligne. Déploiement par Thalès Informatique au Maroc.",
  alternates: {
