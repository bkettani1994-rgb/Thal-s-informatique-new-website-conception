        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
          ...
          >
            ...
            <div className="bg-primary rounded-2xl p-8 text-center">
              ...
              <p data-ilink className="text-white/60 text-sm mb-6">Découvrez notre <Link href="/services/integration-erp" className="text-white underline hover:text-accent">service d'intégrateur ERP au Maroc</Link>.</p>
              <Link
                href="/contact"
