...
export const metadata: Metadata = {
  ...
  description:
    "Loi de finances 2026 : nouveaux taux CNSS et AMO, obligations Damancom et pénalités. Découvrez comment Sage 100 Paie met à jour votre paie automatiquement.",
  alternates: {
