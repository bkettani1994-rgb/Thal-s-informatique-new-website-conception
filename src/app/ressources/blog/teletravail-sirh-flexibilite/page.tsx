...
export const metadata: Metadata = {
  ...
  description:
    "Travail hybride, gestion des plannings flexibles, signature électronique : comment un SIRH moderne aide les entreprises marocaines à s'adapter aux nouvelles attentes des collaborateurs.",
  alternates: {
