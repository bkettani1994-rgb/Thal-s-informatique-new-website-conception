        ...
        <div className="grid grid-cols-2 lg:grid-cols-6 gap-10">
          ...
          <div className="col-span-2 lg:col-span-2">
            ...
            <p className="text-white/65 text-xs leading-relaxed mb-5 max-w-[220px]">
              Votre partenaire de confiance pour la transformation digitale des entreprises en Afrique et à l'international depuis 1996.
            </p>
            ...
            <div className="flex gap-2">
              {[
                { key: "LinkedIn",  href: "https://www.linkedin.com/company/thalesinformatique/" },
                { key: "Facebook",  href: "https://www.facebook.com/Thales.Informatique" },
                { key: "Instagram", href: "https://www.instagram.com/thales.informatique/" },
                { key: "X",         href: "https://x.com/ThalesInfo" },
                { key: "YouTube",   href: "https://www.youtube.com/@thalesinformatique1033" },
              ].map(({ key, href }) => (
                <a
                  key={key}
                  href={href}
